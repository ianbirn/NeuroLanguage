...
/*************************************************/
    ...
    char fileLabel[][3] = {"af", "bg", "cs", "da", "de", "nl", "el", "en", "et", "fi", "fr", "hu", "is", "it", "lv", "lt", "no", "pl", "pt", "ro", "rs", "sk", "sl", "es", "sv", "tk", "uk"};
    ...
    test(N, D, langAM, iMHV, itemMemory, imSize, fileLabel, length);
